...
function insert() {
  ...
  return (
    ...
    <h1 className='text-black  text-lg  pt-8'>Add Details</h1>
...
<div>
  <button  
            className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full pl-28 pr-28 pb-2  mb-5'
            onClick={addData}
          >
            Insert
          </button>
